...
public class SubjectDataResponse implements Comparable {
    String courseCode;
    ...
    public SubjectDataResponse(String courseCode, String curriculumCode, String subjectCode, String term,
                               SubjectMetrics metrics) {
    ...
    public int compareTo(Object o) {
        ...
        SubjectDataResponse otherValue = (SubjectDataResponse) o;
