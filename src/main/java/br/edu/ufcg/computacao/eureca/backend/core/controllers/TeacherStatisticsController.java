...
public class TeacherStatisticsController {
    ...
    public Collection<TeachersSummaryItemResponse> getTeacherStatisticsCSV() {
        ...
        response.add(new TeachersSummaryItemResponse("fubica", 0.12, 0.03, 0.01, 75, "2010.1", "2012.2", new PortugueseStudentsGlossary()));
        response.add(new TeachersSummaryItemResponse("joao arthur", 0.11, 0.08, 0.01, 120, "2010.1", "2012.2", new PortugueseStudentsGlossary()));
        response.add(new TeachersSummaryItemResponse("massoni", 0.09, 0.01, 0.01, 80, "2010.1", "2012.2", new PortugueseStudentsGlossary()));
        return response;
    }
}
