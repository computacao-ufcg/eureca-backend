...
public class ApplicationFacade {
    ...
    public StudentPreEnrollmentResponse getPreEnrollment(String token, String courseCode, String curriculumCode, String registration, Integer numCredits, String optionalPriorityList, String electivePriorityList) throws EurecaException {
        authenticateAndAuthorize(token, EurecaOperation.GET_PRE_ENROLLMENT);
        return this.preEnrollmentController.createStudentPreEnrollment(courseCode, curriculumCode, registration, numCredits, optionalPriorityList, electivePriorityList);
    }
    ...
    public PreEnrollmentsResponse getPreEnrollments(String token, String courseCode, String curriculumCode) throws EurecaException {
        ...
        return this.preEnrollmentController.getPreEnrollments(courseCode, curriculumCode);
    }
