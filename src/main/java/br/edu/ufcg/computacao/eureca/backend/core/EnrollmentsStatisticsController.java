...
public class EnrollmentsStatisticsController {
    ...
    public Collection<EnrollmentsSummaryItemResponse> getEnrollmentsStatisticsCSV() {
        ...
        response.add(new EnrollmentsSummaryItemResponse("eda", 120, 120, 1, "2018.1", "2020.1"));
        response.add(new EnrollmentsSummaryItemResponse("leda", 120, 60, 2, "2018.1", "2020.1"));
        response.add(new EnrollmentsSummaryItemResponse("sistemas operacionais", 100, 33.3, 3, "2013.1", "2019.2"));
        response.add(new EnrollmentsSummaryItemResponse("redes", 80, 40, 2, "2018.1", "2020.1"));
        response.add(new EnrollmentsSummaryItemResponse("logica", 110, 65, 2, "2018.1", "2020.1"));
        return response;
    }
}
