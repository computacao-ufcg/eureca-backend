...
public class NewStudentTest {
    ...
    public void getIdTest() {
        // set up
        NationalIdRegistrationKey expected = new NationalIdRegistrationKey("nationalID","registration1");

        // exercise
        NationalIdRegistrationKey result = new NationalIdRegistrationKey(this.student);
    ...
    public void getStudentDataTest() {
        ...
        // exercise
        StudentData result = new StudentData(this.student);
    ...
    private Student createNewStudent(String nationalId, String registration, int mandatoryHours, int mandatoryCredits, int electiveHours, int electiveCredits,
        ...
        NationalIdRegistrationKey cpfRegistration = new NationalIdRegistrationKey(nationalId,registration);
        br.edu.ufcg.computacao.eureca.backend.core.dao.scsvfiles.mapentries.StudentData studentData = new StudentData("x", "x", "x", "x", "x",
                "x", "x", "x", "Ativo",
                "VESTIBULAR 2007.2", "x", "x", "x",
        ...
        return studentData.createStudent(cpfRegistration);
    }
}
