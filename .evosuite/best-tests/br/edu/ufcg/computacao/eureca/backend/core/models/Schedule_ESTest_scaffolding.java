...
public class Schedule_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "br.edu.ufcg.computacao.eureca.backend.core.models.Schedule"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Comparator", false, Schedule_ESTest_scaffolding.class.getClassLoader()));
  }
